    ...
    return (
        <section id="topStores" className=" pb-20 bg-lightGray">
            <div className="flex flex-col items-center">
                ...
                <p className='text-textGray max-w-lg  mx-auto text-center mb-5 leading-30'>Discover an enhanced search experience, personalized recommendation, streamlined ordering, and faster checkout in our latest update.Elevate yor app usage with these improvements.</p>
